...
import { quickSort, generateRandomArray, QuickSortStep } from '@/lib/quickSort';
            ...
            <div className="bg-slate-900 rounded-lg p-4">
              ...
              <div className="space-y-2">
                ...
                <div className="flex justify-between text-sm">
                  ...
                  <span className="text-slate-400 font-mono">O(log n)</span>
                </div>
                <div className="flex justify-between text-sm">
              ...
              {currentStep ? (
                <div className="space-y-2 text-sm">
                  <div className="flex justify-between">
                    <span className="text-slate-500">Partition Range</span>
                    <span className="text-slate-300">[{currentStep.low}, {currentStep.high}]</span>
                  </div>
                  {currentStep.pivotIndex >= 0 && (
                    <div className="flex justify-between">
                      <span className="text-slate-500">Pivot Value</span>
                      <span className="text-purple-400">{currentStep.array[currentStep.pivotIndex]}</span>
                    </div>
                  )}
                  <div className="flex justify-between">
